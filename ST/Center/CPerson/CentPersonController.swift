...
class CentPersonController: UITableViewController {
    ...
    //MARK:- public 
    static func CenterUserControl() -> UIViewController{
        let storyboard = UIStoryboard.init(name: "STCenter", bundle: nil)
        let control = storyboard.instantiateViewController(withIdentifier: "CentPersonController")
        return control;
    }
