...
class DriHeavQueryController: UIViewController,UITableViewDelegate,UITableViewDataSource{
  ...
  static func HeavQueryControl()-> UIViewController{
    let control = DriHeavQueryController(nibName: "DriHeavQueryController", bundle: nil)
  ...
  @IBAction func clickToQuery(_ sender: UIButton) {
    ...
    if let params = self.paramsQuery(){
      let control = DriHeavQueryResController()
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    if let heavModel = self.dataAry?[indexPath.row]{
